...
const AlternativeQuestionPage: NextPage<{ id: string }> = ({ id }) => {
  ...
  const { isLoading: isLoadingUpdate, mutateAsync: updateQuestion, error } = api.teacher.updateAlternativeQuestion.useMutation();
      ...
      <section className="space-y-5">
        {error?.data?.zodError ? (
          <div className="bg-red-500 p-6">
            <pre className="text-white">{JSON.stringify(error.data.zodError, null, 2)}</pre>
          </div>
        ) : null}
                  ...
                  setAlternatives((alternatives) => [
                    {
                      ...
                      hint: "",
                      isCorrect: false,
                      alternativeQuestionId: alternatives[0]!.alternativeQuestionId,
                    },
                    ...alternatives,
                  ])
                }
